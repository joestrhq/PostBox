...
public enum CurrentEntries {
  ...
  LANG_CMD_POSTBOX_SEND_SEND_EMPTY("commands.postbox-send.send_empty", new int[]{1}),
	LANG_CMD_POSTBOX_SEND_SUCCESS_RECEIVER("commands.postbox-send.success_sender", new int[]{1}),
  LANG_CMD_POSTBOX_SEND_SUCCESS_SENDER("commands.postbox-send.success_receiver", new int[]{1}),
